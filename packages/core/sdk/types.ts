/**
 * B2B SDK Types
 * Types for client integration (YouTube, E-commerce, etc.)
 */
 ...
 */
export type DepositResponse = ExternalDepositResponse | InternalDepositResponse
 ...
 * SDK Configuration
 */
export interface ProxifySDKConfig {
	apiKey: string // Client's API key
	productId: string // Client's product ID
	baseUrl?: string // Proxify API URL (default: production)
