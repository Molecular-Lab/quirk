...
export class ViemClientManager {
  private static readonly publicClients: Map<MockTokenChainId, PublicClient> = new Map()
  private static readonly walletClients: Map<MockTokenChainId, WalletClient> = new Map()
