...
export class UserRepository {
  ...
  async listByClient(clientId: string, limit: number = 100, offset: number = 0): Promise<ListEndUsersRow[]> {
  ...
  async listWithBalances(clientId: string, limit: number = 100): Promise<ListEndUsersWithBalancesRow[]> {
