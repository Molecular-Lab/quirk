export const PROXIFY_CONTROLLER_ABI = [
	{
		inputs: [
			{ internalType: "address", name: "_proxify", type: "address" },
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, internalType: "uint256", name: "tierCount", type: "uint256" },
			{ indexed: false, internalType: "uint256", name: "timestamp", type: "uint256" },
		],
		name: "BatchTierIndicesUpdated",
		type: "event",
	},
	{
		anonymous: false,
	...
	{
		inputs: [{ internalType: "bytes32", name: "tierId", type: "bytes32" }],
		name: "getTierProtocols",
