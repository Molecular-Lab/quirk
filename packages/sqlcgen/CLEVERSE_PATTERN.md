...
┌─────────────────────────────────────────────────────────────┐
│                   Service Layer                             │
│       (DepositService, WithdrawalService, YieldService)     │
...
┌─────────────────────────────────────────────────────────────┐
│                  Repository Layer                           │
│    (VaultRepository, ClientRepository, DepositRepository)   │
│    • Wraps SQLC-generated queries                          │
│    • Adds business logic (BigNumber calculations)          │
...
**What you add:**
- ✅ Complex calculations (BigNumber)
...
│   │   │   ├── vault_sql.ts
│   │   │   └── ...
│   │   └── repositories/                ✅ Your code
│   │       ├── vault.repository.ts      ← Share minting logic
...
│   └── src/
│       └── services/                    ✅ Your code
│           ├── deposit.service.ts       ← Orchestrates repos
...
│   ├── app/
│   │   └── api/                        ✅ Your code
│   │       ├── deposits/route.ts       ← HTTP handlers
│   │       └── users/[id]/balance/route.ts
│   ├── hooks/                          ✅ Your code
│   │   ├── useUserBalance.ts           ← React data fetching
│   │   └── useDeposit.ts
│   └── components/                     ✅ Your code
│       └── UserBalance.tsx             ← UI components
```
...
**This pattern is production-proven by Cleverse!** 🎉
