...
export class ClientResource {
  ...
  async listByPrivyOrganization(privyOrganizationId: string): Promise<Client[]> {
    return this.http.get<Client[]>(
      `/api/v1/clients/privy/${privyOrganizationId}`
    )
  }
  ...
  async updateOrganization(
    ...
    return this.http.patch(
      `/api/v1/clients/product/${productId}/organization`,
      data
    )
  }
  ...
  async updateCurrencies(
    ...
    return this.http.patch(
      `/api/v1/clients/product/${productId}/currencies`,
      data
    )
  }
  ...
  async configureBankAccounts(
    ...
    return this.http.post(
      `/api/v1/clients/product/${productId}/bank-accounts`,
      data
    )
  }
