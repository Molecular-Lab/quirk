...
export const queryKeys = {
	...
	transactions: {
		...
		list: (filters?: { type?: string; userId?: string }) => [...queryKeys.transactions.all, "list", filters] as const,
	...
	deposits: {
		...
		list: (userId: string, page?: number) => [...queryKeys.deposits.lists(), userId, page] as const,
