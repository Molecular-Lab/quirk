...
import { Book, Code, Copy, Eye, EyeOff, Plus, Trash2 } from "lucide-react"
		...
		<div className="min-h-full bg-white">
			<div className="max-w-[1400px] mx-auto px-6 py-8">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600">Documentation and API keys for integrating Proxify into your application</p>
				</div>
					...
					<div className="flex gap-8">
						<button
							...
							className={`pb-4 px-2 font-medium text-sm transition-colors relative ${
								activeTab === "docs" ? "text-blue-600" : "text-gray-500 hover:text-gray-700"
							}`}
						>
							Documentation
						...
						<button
							...
							className={`pb-4 px-2 font-medium text-sm transition-colors relative ${
								activeTab === "api-keys" ? "text-blue-600" : "text-gray-500 hover:text-gray-700"
							}`}
						>
							API Keys
						...
						<div className="lg:col-span-3 space-y-8">
							...
							<div className="bg-gray-50 rounded-2xl p-6">
								...
								<p className="text-gray-600 mb-6">
									Get started with Proxify API in minutes. Install the SDK and start accepting deposits.
								</p>
								...
								<div className="bg-gray-900 rounded-lg p-4 mb-4">
									<div className="flex items-center justify-between mb-2">
										...
										<button
											onClick={() => {
												copyToClipboard("npm install @proxify/b2b-client")
											}}
									...
									<code className="text-sm text-green-400 font-mono">npm install @proxify/b2b-client</code>
								</div>
								...
								<div className="space-y-4">
									<div className="bg-white rounded-lg p-4 border-l-4 border-blue-500">
										<div className="flex items-center gap-3 mb-2">
											<span className="px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded">POST</span>
											<code className="text-sm font-mono text-gray-900">/api/v1/deposits</code>
										</div>
									...
									<div className="bg-white rounded-lg p-4 border-l-4 border-green-500">
										<div className="flex items-center gap-3 mb-2">
											<span className="px-2 py-0.5 bg-green-100 text-green-800 text-xs font-bold rounded">GET</span>
											<code className="text-sm font-mono text-gray-900">/api/v1/deposits/:orderId</code>
										</div>
									...
									<div className="bg-white rounded-lg p-4 border-l-4 border-green-500">
										<div className="flex items-center gap-3 mb-2">
											<span className="px-2 py-0.5 bg-green-100 text-green-800 text-xs font-bold rounded">GET</span>
											<code className="text-sm font-mono text-gray-900">/api/v1/deposits/client-balance</code>
										</div>
							...
							<div className="bg-blue-50 rounded-2xl p-6 border border-blue-200">
								...
								<div className="bg-white rounded-lg p-4">
									...
									<ul className="space-y-1 text-sm text-gray-600">
										<li>
											• <code>deposit.completed</code> - Deposit successfully processed
										</li>
										<li>
											• <code>deposit.failed</code> - Deposit failed
										</li>
										<li>
											• <code>withdrawal.completed</code> - Withdrawal completed
										</li>
									</ul>
								</div>
							</div>
				...
				{activeTab === "api-keys" && (
					<div>
						<div className="flex items-center justify-between mb-6">
							<p className="text-gray-600">Manage your API keys for accessing Proxify services</p>
							<button
								onClick={() => {
						...
						<div className="space-y-4">
							{apiKeys.map((apiKey) => (
								<div key={apiKey.id} className="bg-gray-50 rounded-2xl p-6 hover:shadow-md transition-shadow">
