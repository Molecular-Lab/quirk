						...
						<div className="space-y-5">
							...
							<div className="bg-gray-50 rounded-2xl p-4 border border-gray-200">
								<div className="text-center mb-4">
									...
									<p className="text-sm text-gray-500 mt-1">
										{percentage}% of ${currentBalance.toLocaleString()}
									</p>
								</div>
							</div>
							...
							<div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-start gap-2">
								...
								<p className="text-xs text-amber-700">
									Funds will be withdrawn from DeFi protocols (AAVE, Compound, Morpho) on mainnet. This process may take
									a few minutes.
								</p>
							</div>
					...
					{step === "confirm" && (
						<div className="space-y-5">
								...
								<div className="space-y-2 text-sm">
									...
									<div className="flex justify-between">
										...
										<span className="font-semibold text-gray-900">
											$
											{(currentBalance - withdrawalAmount).toLocaleString(undefined, {
							...
							<div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-start gap-2">
								...
								<p className="text-xs text-amber-700">
									You're withdrawing a large amount (${withdrawalAmount.toLocaleString()}). Please confirm that you want
