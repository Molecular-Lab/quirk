						...
						<div className="bg-white rounded-2xl p-12 text-center border border-gray-200">
							<div className="max-w-md mx-auto">
								...
								<p className="text-gray-600 mb-6">
									Process user withdrawal requests (USDC → Fiat) in batches. Select bank accounts, confirm transfers,
									and send fiat to end-users.
								</p>
								<div className="space-y-3 text-left bg-gray-50 rounded-xl p-4">
									<div className="flex items-start gap-3">
										...
										<div>
											<p className="text-sm font-semibold text-gray-900">Review Withdrawal Requests</p>
											<p className="text-xs text-gray-600">End-users request to withdraw USDC to fiat currency</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										...
										<div>
											<p className="text-sm font-semibold text-gray-900">Select Bank Account</p>
											<p className="text-xs text-gray-600">Choose registered bank account for each currency</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										...
										<div>
											<p className="text-sm font-semibold text-gray-900">Execute Batch Transfer</p>
											<p className="text-xs text-gray-600">Process withdrawals and send fiat to end-users</p>
										</div>
									</div>
								</div>
								<div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
									<p className="text-sm text-blue-700">
										<strong>💡 Note:</strong> This feature will mirror the on-ramp flow in reverse. Configure your bank
										accounts in{" "}
										<a href="/dashboard/product-config" className="underline font-semibold">
											Product Config
										</a>{" "}
										first.
									</p>
