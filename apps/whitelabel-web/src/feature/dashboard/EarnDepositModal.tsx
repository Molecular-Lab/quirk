...
import { Check, ExternalLink, AlertTriangle, TrendingUp, Loader2, Info } from "lucide-react"
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 flex items-start gap-2">
                                ...
                                <p className="text-xs text-blue-700">
                                    Your funds will be staked into real DeFi protocols (AAVE, Compound, Morpho)
                                    on mainnet. Earnings are accrued daily.
                                </p>
                            </div>
                            ...
                            <Button
                                ...
                                disabled={!isValidAmount || !authenticated || balanceLoading || !!balanceError}
                                className="w-full py-4 rounded-2xl font-bold text-lg"
                            >
                                {balanceLoading ? "Loading balance..." : balanceError ? "Cannot proceed - balance error" : "Continue"}
                            </Button>
                        </div>
                    )}
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    {gasLoading ? (
                                        ...
                                        <span className="font-semibold text-gray-900">
                                            ~${gasEstimate?.estimatedCostUSD || "0.50"}
                                        </span>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-start gap-2">
                                ...
                                <p className="text-xs text-amber-700">
                                    By proceeding, your funds will be staked into DeFi protocols.
                                    You can withdraw at any time, subject to protocol conditions.
                                </p>
                            </div>
                    ...
                    {step === "processing" && (
                        <div className="py-12 text-center">
                            ...
                            <p className="text-sm text-gray-600">
                                Processing deposits across {allocations.length} protocols
                            </p>
