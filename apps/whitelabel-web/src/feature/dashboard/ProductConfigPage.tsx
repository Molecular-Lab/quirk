...
Help them understand or refine their strategy.`
	...
	// Note: handleStrategyChange was removed since we're no longer using ProductStrategyConfig component
	// The investment strategy is now managed through the risk profile and allocation UI above
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<div className="bg-white/90 backdrop-blur-md rounded-xl shadow-sm border border-gray-150 p-8">
							...
							{/* Risk Profile Cards */}
							<div className="mb-6">
								<h3 className="text-sm font-semibold text-gray-700 mb-3">Choose Risk Profile</h3>
							...
							<div className="mb-6">
								<div className="flex justify-between items-center mb-4">
									<h3 className="text-sm font-semibold text-gray-700">Allocation Overview</h3>
							...
							<button
								...
								className="w-full py-3 px-6 rounded-xl border-2 border-gray-200 bg-white text-gray-700 font-medium hover:border-gray-300 hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
							>
