...
export function PortfolioDetailPage() {
	// TODO: Use portfolio ID from route params when backend is ready
				...
				<div className="bg-gray-50 rounded-3xl p-6 mb-6">
					<div className="flex items-start justify-between mb-6">
						...
						<div className="flex gap-1">
							<button className="px-2.5 py-1 text-xs text-gray-500 hover:text-gray-900 hover:bg-white rounded-md transition-colors">
								1D
							</button>
							<button className="px-2.5 py-1 text-xs text-gray-500 hover:text-gray-900 hover:bg-white rounded-md transition-colors">
								1W
					...
					<div className="h-[280px] -mx-2">
						<ResponsiveContainer width="100%" height="100%">
							<LineChart data={balanceData}>
								...
								/>
								<Line type="monotone" dataKey="value" stroke="#00D9A3" strokeWidth={2.5} dot={false} />
							</LineChart>
						</ResponsiveContainer>
					</div>
				</div>
