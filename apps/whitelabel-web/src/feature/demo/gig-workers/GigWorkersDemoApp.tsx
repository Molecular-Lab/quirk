...
export function GigWorkersDemoApp() {
	...
	const fetchBalance = async () => {
		...
		try {
			console.log("[GigWorkersDemoApp] Fetching real balance for user:", endUserId, "environment:", selectedEnvironment)
	...
	useEffect(() => {
		const checkExistingUser = async () => {
			...
			try {
				console.log("[GigWorkersDemoApp] Checking for existing user:", personaUserId)
				...
				if (user) {
					...
					console.log("[GigWorkersDemoApp] Found existing user:", user.id)
				}
			} catch (err) {
				// Non-blocking - user can still create new account
				console.warn("[GigWorkersDemoApp] Failed to check for existing user:", err)
			}
		}
