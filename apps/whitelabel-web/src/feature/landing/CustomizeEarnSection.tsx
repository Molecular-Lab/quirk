		...
		<section className="min-h-[90vh] py-20 bg-gradient-to-b from-blue-50/30 to-white flex items-center">
			<div className="max-w-7xl mx-auto px-6 w-full">
				<div className="text-center mb-16">
					<h2 className="text-6xl font-bold text-gray-950 mb-6">Customize Earn Solution At Scale</h2>
				...
				<div className="grid md:grid-cols-3 gap-6">
					<div className="bg-white/90 backdrop-blur-md rounded-xl p-8 border border-gray-150 hover:shadow-md hover:border-gray-200 transition-all">
						...
						<h3 className="text-2xl font-semibold text-gray-950 mb-4">Fast Integration</h3>
					...
					<div className="bg-white/90 backdrop-blur-md rounded-xl p-8 border border-gray-150 hover:shadow-md hover:border-gray-200 transition-all">
						<div className="text-4xl mb-4">🔒</div>
						<h3 className="text-2xl font-semibold text-gray-950 mb-4">Secure Custody</h3>
						<p className="text-lg text-gray-700 leading-relaxed">
					...
					<div className="bg-white/90 backdrop-blur-md rounded-xl p-8 border border-gray-150 hover:shadow-md hover:border-gray-200 transition-all">
						<div className="text-4xl mb-4">📊</div>
						<h3 className="text-2xl font-semibold text-gray-950 mb-4">White-Label Dashboard</h3>
						<p className="text-lg text-gray-700 leading-relaxed">
