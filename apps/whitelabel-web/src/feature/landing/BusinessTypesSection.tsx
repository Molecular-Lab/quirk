	...
	const businessTypes = [
		{
			...
			description:
				"Enable merchants and users to earn yield on idle balances. Seller pending payouts, user wallets, and treasury funds generate returns while waiting for settlement.",
			icon: "🛍️",
			companies: [
				{ name: "Shopify", logo: "🏪" },
				{ name: "Stripe", logo: "💳" },
	...
	return (
		<section className="py-20 bg-white">
			<div className="max-w-7xl mx-auto px-6">
				...
				{/* Business Type Cards - Horizontal Scroll */}
				<div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
					{businessTypes.map((type, idx) => (
						<div
							key={idx}
							className="flex-shrink-0 w-[450px] bg-white rounded-xl border-t-4 border-blue-500 border-x border-b border-gray-200 p-8 hover:shadow-lg transition-all snap-start"
						>
							{/* Icon & Title */}
