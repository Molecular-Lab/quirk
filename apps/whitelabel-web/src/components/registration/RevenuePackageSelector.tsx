...
export default function RevenuePackageSelector({
  selectedPackage,
  onSelect,
}: RevenuePackageSelectorProps) {
  const [hoveredPackage, setHoveredPackage] = useState<string | null>(null)

  return (
    <div className="bg-white rounded-lg p-8">
      <h3 className="text-2xl font-bold text-gray-900 mb-2 text-center">
        Choose Your Revenue Package
      </h3>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
        <p className="text-sm text-blue-900">
          💡 <strong>Performance fees</strong> are only charged on profits. Management fees
          are calculated on AUM (Assets Under Management).
        </p>
      </div>
    </div>
  )
