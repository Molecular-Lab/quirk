...
const MOCK_RESPONSES: Record<number, ChatMessage> = {
  0: {
    id: '0',
    role: 'assistant',
    content: "👋 Hello! I'm Proxify AI Assistant. I'll help you design the perfect DeFi strategy for your business. Let's start with understanding your goals. What type of business are you running?",
    timestamp: new Date(),
  },
  1: {
    id: '2',
    role: 'assistant',
    content: "Great! For e-commerce businesses, we typically recommend strategies that balance growth with stability. How many users do you expect to onboard initially?",
    timestamp: new Date(),
  },
  2: {
    id: '4',
    role: 'assistant',
    content: "Perfect! For 1000-5000 users, we can design a scalable strategy. What's your risk tolerance? (Conservative, Moderate, or Aggressive)",
    timestamp: new Date(),
  },
  3: {
    id: '6',
    role: 'assistant',
    content: "Excellent choice! A moderate approach balances safety and returns. What's your primary goal: (1) Stable passive income, (2) Growth + liquidity, or (3) Maximum yield?",
    timestamp: new Date(),
  },
  4: {
    id: '8',
