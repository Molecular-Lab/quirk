...
- Add tag in format `{service}@v{x.x.x}` e.g. `api@v0.1.0`. It will build an image via
  [Github Action](https://github.com/Cleverse/rabbitswap-interface/actions)
- Update the deployed version at [rabbitswap-gitops](https://github.com/Cleverse/rabbitswap-gitops)
