...
import { MaxUint256, ONE, Q32, ZERO } from "@/constants/jsbi"

/**
 * copy from https://github.com/Uniswap/v3-sdk/blob/main/src/utils/mostSignificantBit.ts
 */
...
export class TickMath {
	...
	static bound(tick: number): number {
