...
export const HistoryOrderTable: React.FC = () => {
	...
	const baseOrders = useMemo(() => limitOrdersData?.inactive, [limitOrdersData])
	...
	const columns = useColumn({ isLoading: isLoading, orderState: "inactive" })
